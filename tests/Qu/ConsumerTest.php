...
class ConsumerTest extends PHPUnit_Framework_TestCase
{
	...
	/**
	 * @covers Qu\Consumer::bindQueue
	 */
	public function testBindQueue() {
		$queue = 'queue';
		$this->fixture->bindQueue($queue);
		$this->assertSame($queue, $this->fixture->queue);
	}
	...
	public function testConsumeFireCallbacks() {
		...
		$func = function ($arg) { throw new \Exception('callback executed'); };
	...
	public function testConsumeFireCallbacksPropagationStopped() {
		...
		$func = function ($arg) { throw new \Exception('should not be executed'); };
		$this->fixture->addCallback($func);
		$this->fixture->consume('queue', 10);
	}
